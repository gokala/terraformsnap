...
module "vnet" {
  source              = "git::https://github.com/gokala/terraformsnap.git/Modules/Vnet?ref=master"
  ...
  */
 module "Cloudera" {
  source              = "git::https://github.com/gokala/terraformsnap.git/Modules/Virtual_Machine?ref=master"
